...
import unittest
from classifier.model.classifier_drop_request import ClassifierDropRequest


class TestClassifierDropRequest(unittest.TestCase):


  def test_getters(self) -> None:
    # Given
    request = ClassifierDropRequest(123)
  ...
  def test_from_json(self) -> None:
    ...
    # When
    actual_request = ClassifierDropRequest.from_json(json)

    # Then
    expected_request = ClassifierDropRequest(123)
  ...
  def test_equal_false(self) -> None:
    # Given
    request1 = ClassifierDropRequest(123)
    request_id_diff = ClassifierDropRequest(1234)
  ...
  def test_equal_true(self) -> None:
    # Given
    request1 = ClassifierDropRequest(123)
    request2 = ClassifierDropRequest(123)
