...
class TestClassifierCancelRequest(unittest.TestCase):
  ...
  def test_getters(self) -> None:
    # Given
    request = ClassifierCancelRequest(123, ClassifierType.DECISION_TREE)
  ...
  def test_from_json(self) -> None:
    ...
    # Then
    expected_request = ClassifierCancelRequest(123, ClassifierType.DECISION_TREE)
  ...
  def test_equal_false(self) -> None:
    # Given
    request1 = ClassifierCancelRequest(123, ClassifierType.DECISION_TREE)
    request_id_diff = ClassifierCancelRequest(1234, ClassifierType.DECISION_TREE)
    request_classifier_type_diff = ClassifierCancelRequest(123, None)
  ...
  def test_equal_true(self) -> None:
    # Given
    request1 = ClassifierCancelRequest(123, ClassifierType.DECISION_TREE)
    request2 = ClassifierCancelRequest(123, ClassifierType.DECISION_TREE)
