...
testapp = engine.app.test_client()
...
class TestTimeSeriesAnalysisController(unittest.TestCase):
  ...
  def test_forecast(self):
    ...
    #When
    response = testapp.post('/time-series-analysis/forecast', data = body_as_string, content_type = 'application/json')
  ...
  def test_compute_forecast_accuracy(self):
    ...
    #When 
    response = testapp.post('/time-series-analysis/forecast-accuracy', data = body_as_string, content_type = 'application/json')
  ...
  def test_predict(self):
    ...
    #When
    response = testapp.post('/time-series-analysis/predict', data = body_as_string, content_type = 'application/json')
    actual_time_series = TimeSeries.from_json(json.loads(response.data))
