...
public interface Orchestrator {
  ...
  <Result> Result priorityRunOnEngine(int engineId, String actionName, Function<Engine, Result> action);

  <Result> List<Result> priorityRunOnAllEngines(String actionName, Function<Engine, Result> action);
