...
public class DecisionTreeApiImpl implements DecisionTreeApi {
  ...
  public ResponseEntity<ClassifierStartResponseModel> start(ClassifierStartRequestModel classifierStartRequestModel) {
    ...
    ClassifierStartResponse startResponse = service.start(ClassifierStartRequestMapper.fromServiceModel(requestId, classifierStartRequestModel, DECISION_TREE));
  ...
  public ResponseEntity<Void> data(ClassifierDataRequestModel classifierDataRequestModel) {
    ...
    service.data(ClassifierDataRequestMapper.fromServiceModel(classifierDataRequestModel, DECISION_TREE));
  ...
  public ResponseEntity<ClassifierResponseModel> predict(ClassifierRequestModel classifierRequestModel) {
    ...
    ClassifierResponse response = service.predict(ClassifierRequestMapper.fromServiceModel(classifierRequestModel, DECISION_TREE));
  ...
  public ResponseEntity<BigDecimal> computePredictAccuracy(ClassifierRequestModel classifierRequestModel) {
    ...
    Double accuracy = service.computePredictAccuracy(ClassifierRequestMapper.fromServiceModel(classifierRequestModel, DECISION_TREE));
