...
public class TimeSeriesAnalysisServiceImpl implements TimeSeriesAnalysisService {
  ...
  public TimeSeries forecast(TimeSeriesAnalysisRequest timeSeriesAnalysisRequest) {
    try {
      ...
      LOGGER.error(format("Exception while forecasting: %s", exception.getMessage()), exception);
  ...
  public Double computeForecastAccuracy(TimeSeriesAnalysisRequest timeSeriesAnalysisRequest) {
    try {
      ...
      LOGGER.error(format("Exception while computing forecast accuracy: %s", exception.getMessage()), exception);
      throw new TimeSeriesAnalysisServiceException(exception.getMessage());
    } finally {
  ...
  public TimeSeries predict(TimeSeriesAnalysisRequest timeSeriesAnalysisRequest) {
    try {
      ...
      LOGGER.error(format("Exception while predicting: %s", exception.getMessage()), exception);
      throw new TimeSeriesAnalysisServiceException(exception.getMessage());
    } finally {
