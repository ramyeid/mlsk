...
public final class TimeSeriesMapper {
  ...
  public static TimeSeries fromServiceModel(TimeSeriesModel timeSeriesModel) {
    List<TimeSeriesRow> rows = timeSeriesModel.getRows().stream().map(TimeSeriesRowMapper::fromServiceModel).collect(toList());
  ...
  public static TimeSeriesModel toServiceModel(TimeSeries timeSeries) {
    List<TimeSeriesRowModel> rows = timeSeries.getRows().stream().map(TimeSeriesRowMapper::toServiceModel).collect(toList());
