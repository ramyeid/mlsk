...
public class DecisionTreeStartIT extends AbstractIT {
  ...
  public void should_throw_exception_if_engine_returns_an_exception_on_start() {
    ...
    MockEngine.MockedRequest startRequest = buildFailingMockRequest(ENDPOINT1, START_URL, buildEngineClassifierStartRequestModel(requestId), exceptionToThrow);
  ...
  public void should_release_engine_on_exception_on_start() {
    ...
    ClassifierStartRequestModel startRequestModel = buildServiceClassifierStartRequestModel();
    HttpServerErrorException exceptionToThrow = buildHttpServerErrorException(HttpStatus.BAD_REQUEST, "Exception NPE raised while starting: NullPointer");
    MockEngine.MockedRequest failingStartRequest = buildFailingMockRequest(ENDPOINT1, START_URL, buildEngineClassifierStartRequestModel(requestId1), exceptionToThrow);
    MockEngine.MockedRequest startRequest1 = buildMockRequest(ENDPOINT1, START_URL, buildEngineClassifierStartRequestModel(requestId2), buildDefaultResponse());
    MockEngine.MockedRequest startRequest2 = buildMockRequest(ENDPOINT2, START_URL, buildEngineClassifierStartRequestModel(requestId3), buildDefaultResponse());
  ...
  public void should_call_cancel_on_exception_on_start() throws Exception {
    ...
    ClassifierStartRequestModel startRequestModel = buildServiceClassifierStartRequestModel();
    HttpServerErrorException exceptionToThrow = buildHttpServerErrorException(HttpStatus.BAD_REQUEST, "Exception NPE raised while starting: NullPointer");
    MockEngine.MockedRequest failingStartRequest = buildFailingMockRequest(ENDPOINT1, START_URL, buildEngineClassifierStartRequestModel(requestId), exceptionToThrow);
    MockEngine.MockedRequest cancelRequest = buildMockRequest(ENDPOINT1, CANCEL_URL, buildEngineClassifierCancelRequestModel(requestId), buildDefaultResponse());
    mockEngine.registerRequests(failingStartRequest, cancelRequest);
